package com.deeplake.noteblockne.events;
...
import static com.deeplake.noteblockne.util.IDLNBT.*;
...
//				  CommonFunctions.SendMsgToPlayerStyled((EntityPlayerMP)player, "noteblockne.msg.starter_kit_given", TextFormatting.AQUA);
//			  }
