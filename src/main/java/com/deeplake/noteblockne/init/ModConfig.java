...
public class ModConfig {
    ...
    @Config.LangKey("configgui.noteblockne.category.Menu0.GeneralConf")
...
//        @Config.LangKey("noteblockne.conf.general.welcome")
//        @Config.Comment("The text shown when a player logs in. Can be a key or a string.")
//        public String WELCOME_MSG = "noteblockne.msg.welcome";
    }

    @Config.LangKey("configgui.noteblockne.category.Menu0.DebugConf")
    ...
    @Config.LangKey("configgui.noteblockne.category.Menu0.SpawnConf")
