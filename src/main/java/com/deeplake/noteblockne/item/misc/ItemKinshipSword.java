package com.deeplake.noteblockne.item.misc;

import com.deeplake.noteblockne.item.IGuaEnhance;
import com.deeplake.noteblockne.item.ItemSwordBase;
import com.deeplake.noteblockne.util.IDLGeneral;
...
import static com.deeplake.noteblockne.util.IDLSkillNBT.GetGuaEnhance;
...
//    public com.deeplake.noteblockne.item.skills.martial.BuffTuple GetWaterBuff(ItemStack stack)
//    {
//        int water = GetGuaEnhance(stack, 2);
//        return new com.deeplake.noteblockne.item.skills.martial.BuffTuple(water / 4, TICK_PER_SECOND * water * 2);
//    }
//
//    public com.deeplake.noteblockne.item.skills.martial.BuffTuple GetMountainBuff(ItemStack stack)
//    {
//        int gua = GetGuaEnhance(stack, 4);
//        return new com.deeplake.noteblockne.item.skills.martial.BuffTuple(gua / 4, TICK_PER_SECOND * gua * 2);
//    }
//
