...
import static com.deeplake.noteblockne.util.NBTStrDef.IDLNBTDef.STATE;
import static com.deeplake.noteblockne.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.deeplake.noteblockne.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "noteblockne.msg.being_targeted";
