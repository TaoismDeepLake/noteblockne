...
public class ModSoundHandler {
    ...
    public static SoundEvent basedrum = new ModSoundEvent("bd_pp");
    ...
    public static SoundEvent chime = new ModSoundEvent("icechime_pp");
    public static SoundEvent xylobone = new ModSoundEvent("xylobone_pp");

    public static SoundEvent mm_harp = new ModSoundEvent("harp_mm");
    public static SoundEvent mm_basedrum = new ModSoundEvent("bd_mm");
    ...
    public static SoundEvent mm_chime = new ModSoundEvent("icechime_mm");
    public static SoundEvent mm_xylobone = new ModSoundEvent("xylobone_mm");

    public static SoundEvent p4_harp = new ModSoundEvent("harp_pp_pp");
    public static SoundEvent p4_basedrum = new ModSoundEvent("bd_pp_pp");
    ...
    public static SoundEvent p4_chime = new ModSoundEvent("icechime_pp_pp");
    public static SoundEvent p4_xylobone = new ModSoundEvent("xylobone_pp_pp");
